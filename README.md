...
| [#3](https://github.com/alleboudy/llm-finetuner/issues/3) | Fleet guide: parallel & distributed QLoRA across N Dell Precision laptops | How to scale beyond one machine. Two paths: parallel HP sweep (recommended) and distributed data-parallel training (rarely worth it on 1 Gbps LAN). Dell-specific power/thermal config. |
