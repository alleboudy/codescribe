...
| **Ada Lovelace** (4060, 4070, 4080, 4090, L40, RTX 2000 Ada) | 2022 | sm_89 | yes | yes | yes |
...
- **Ada (sm_89)** — what the RTX 2000 Ada Laptop runs (Dell Precision fleet target).
...
- The OEM has set conservative defaults (Dell "Optimized" thermal profile halves performance vs "Ultra Performance").
